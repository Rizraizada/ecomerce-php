					...
					<div class="panel">
						<div class="panel-body">
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="mailto:shohag.aus@gmail.com"> 
									<i class="fa fa-envelope"></i> &nbsp; shohag.aus@gmail.com
								</a>
							</div>
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="callto:8801316440504" style="margin-right: 8px;"> 
									<i class="fa fa-phone"></i> &nbsp; +880 1965838328
								</a>
								<a class="btn p-follow-btn" href=""> 
									<i class="fa fa-skype"></i> &nbsp; Md.Shohag
								</a>
							</div>
						</div>
					</div>
