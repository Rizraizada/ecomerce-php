...
if ($_SERVER['SERVER_NAME'] == "localhost") {
  $server_name = 'http://localhost/ecommerce.besttechbd.com/'; // Use http:// for localhost development
} else {
  $server_name = 'https://ecommerce.besttechbd.com/'; // Use https:// for your production server
}
