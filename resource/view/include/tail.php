							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										...
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">(+880) 1701886690</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="sohagh.aus@gmail.com">sohagh.aus@gmail.com</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="" target="_blank"> Md.Sohag</a>
						</p>
						...
						<div class="social-icons">
							<a href="https://aamroni.info" target="_blank" style="margin: 0px 10px;">
								<img src="public/assets\images\icons\sohag.jpg" class="rounded-circle" style="width:32px; height:32px;">
							</a>				
							<a href="https://www.facebook.com/sohagh.profile" class="social-icon" target="_blank">
								<i class="icon-facebook"></i>
							</a>
							<a href="https://www.linkedin.com/in/md-sohagh-mia?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" class="social-icon" target="_blank">
